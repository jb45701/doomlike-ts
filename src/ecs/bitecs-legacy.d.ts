declare module 'bitecs/legacy' {
  ...
  export const Types: {
    i8: 'i8'; ui8: 'ui8'; ui8c: 'ui8c';
    i16: 'i16'; ui16: 'ui16';
    i32: 'i32'; ui32: 'ui32';
    f32: 'f32'; f64: 'f64'; eid: 'eid';
  };

  type Component = Record<string, Int32Array | Float32Array | Uint8Array | Uint32Array | Uint16Array | Int16Array | Float64Array>;

  export function defineComponent(schema: Record<string, string>, max?: number): Component;
  export function defineComponent(schema?: Record<string, never>, max?: number): {};

  export function defineQuery(components: any[]): (world: World) => Readonly<Uint32Array>;
